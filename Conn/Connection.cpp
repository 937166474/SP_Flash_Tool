...
ZHRESULT Connection::conn_da()
{
    ...
    //DA SLA cmd should be the first cmd to execute after connected DA
    std::shared_ptr<DASLACmdHandler> dasla_handler = std::make_shared<DASLACmdHandler>();
    dasla_handler->DASLAVerify(shared_from_this());
