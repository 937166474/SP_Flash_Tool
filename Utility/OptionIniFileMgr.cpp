...
bool OptionIniFileMgr::getBoot_to_fastmode() const
{
    return m_boot_to_fastmode;
}
...
void OptionIniFileMgr::loadOptionFile()
{
    ...
    item.SetItemName(QStringLiteral("BootToFastMode"));
    m_boot_to_fastmode = item.GetBooleanValue();
