#ifndef BROMWRITEREGISTERCMDXMLGENERATOR_H
#define BROMWRITEREGISTERCMDXMLGENERATOR_H
...
class BromWriteRegCmdXML : public ICmdXMLGenerator
{
public:
    BromWriteRegCmdXML();
...
#endif // BROMWRITEREGISTERCMDXMLGENERATOR_H
