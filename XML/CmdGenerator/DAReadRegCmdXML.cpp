#include "DAReadRegCmdXML.h"

DAReadRegCmdXML::DAReadRegCmdXML():
    ICmdXMLGenerator(DA_READ_REGISTER_CMD_VER_VAL, DA_READ_REGISTER_CMD_NAME_VAL, DA_NODE_NAME),
...
void DAReadRegCmdXML::setRegisterBitWidth(REGISTER_BIT_WIDTH_TYPE register_bit_width)
{
    m_register_bit_width = register_bit_width;
}

void DAReadRegCmdXML::setBaseAddress(const QString &base_address)
{
...
*/
void DAReadRegCmdXML::fillArgNode(QDomElement * const arg_node)
{
...
void DAReadRegCmdXML::setFileType(FILE_TYPE file_type)
{
    m_target_file_assist->setFileType(file_type);
}

void DAReadRegCmdXML::setFileName(const QString &file_name)
{
    m_target_file_assist->setFileName(file_name);
}

QString DAReadRegCmdXML::getCmdXMLValue() const
{
    return m_target_file_assist->getCmdXMLValue();
}

QString DAReadRegCmdXML::getRegisterBitWidth() const
{
