#include "DAWriteRegCmdXML.h"

DAWriteRegCmdXML::DAWriteRegCmdXML():
...
void DAWriteRegCmdXML::setRegisterBitWidth(REGISTER_BIT_WIDTH_TYPE register_bit_width)
{
    m_register_bit_width = register_bit_width;
}

void DAWriteRegCmdXML::setBaseAddress(const QString &base_address)
{
...
*/
void DAWriteRegCmdXML::fillArgNode(QDomElement * const arg_node)
{
...
void DAWriteRegCmdXML::setFileType(FILE_TYPE file_type)
{
    m_source_file_assist->setFileType(file_type);
}

void DAWriteRegCmdXML::setFileName(const QString &file_name)
{
    m_source_file_assist->setFileName(file_name);
}

void DAWriteRegCmdXML::setMemInfo(const QString &start_address, const QString &length)
{
    m_source_file_assist->setStartAddress(start_address);
    m_source_file_assist->setLength(length);
}

QString DAWriteRegCmdXML::getRegisterBitWidth() const
{
