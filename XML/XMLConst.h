...
#define CMD_VERSION_1_2_VALUE "1.2"
...
#define DEBUG_UFS_UPDATE_FIRMWARE_CMD_VER_VAL     CMD_VERSION_VALUE
#define DEBUG_UFS_SETTING_CMD_VER_VAL             CMD_VERSION_1_2_VALUE
...
#define GET_SYS_PROPERTY_CMD_VER_VAL                    CMD_VERSION_VALUE
#define GET_SYS_PROPERTY_CMD_NAME_VAL                   "CMD:GET-SYS-PROPERTY"
...
#define HPB_CTRL_MODE_NODE_NAME QStringLiteral("ctrl_mode")
#define RND_NODE_NAME QStringLiteral("rnd")
#define HRID_NODE_NAME QStringLiteral("hrid")
#define SOCID_NODE_NAME QStringLiteral("socid")
#define SWITCH_NODE_NAME QStringLiteral("switch")

//cmd property name
#define NAME_ATTR_NAME    QStringLiteral("name")
#define ITEM_ATTR_NAME    QStringLiteral("item")
#define KEY_ATTR_NAME     KEY_NODE_NAME
#define WT_SIZE_ATTR_NAME QStringLiteral("wt_size")
#define WT_REDUCTION_ATTR_NAME QStringLiteral("wt_reduction")
#define HPB_SIZE_ATTR_NAME QStringLiteral("hpb_size")
#define HPB_PINNED_INDEX_ATTR_NAME QStringLiteral("hpb_pinned_region_start_index")
#define HPB_PINNED_CNT_ATTR_NAME QStringLiteral("hpb_pinned_region_count")
#define HPB_CTRL_MODE_ATTR_NAME QStringLiteral("hpb_ctrl_mode")
#define SLL_SIZE_ATTR_NAME QStringLiteral("sll_size")
#define SLL_TYPE_ATTR_NAME QStringLiteral("sll_type")

//cmd node or property value name
#define DA_SLA_VAL_NAME QStringLiteral("DA.SLA")
